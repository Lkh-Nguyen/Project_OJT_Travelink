...
public class CustomerService {
    ...
    // return "<div
    // style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n"
    // +
    // "<span
    // style=\"display:none;font-size:1px;color:#fff;max-height:0\"></span>\n" +
    ...
    // +
    // " <span
    // style=\"font-family:Helvetica,Arial,sans-serif;font-weight:700;color:#ffffff;text-decoration:none;vertical-align:top;display:inline-block\">Thank
    ...
    // 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + name + ",</p>\n" +
    // " <p style=\"Margin:0 0 20px
    // 0;font-size:19px;line-height:25px;color:#0b0c0c\">Thank you for registering
    // and trusting Travelink. We are excited to have you on board!</p>\n" +
    // " <p style=\"Margin:0 0 20px
    // 0;font-size:19px;line-height:25px;color:#0b0c0c\">You can start exploring our
    // services by visiting our <a href=\"[YOUR_LINK]\">website</a>.</p>\n" +
    // " <p style=\"Margin:0 0 20px
    // 0;font-size:19px;line-height:25px;color:#0b0c0c\">If you have any questions
    // or need assistance, feel free to reach out to our support team.</p>\n" +
    // " <p style=\"Margin:0 0 20px
    // 0;font-size:19px;line-height:25px;color:#0b0c0c\">See you soon!</p>\n" +
    // " </td>\n" +
    // " </tr>\n" +
    // " <tr>\n" +
    // " <td height=\"30\"><br></td>\n" +
